...
class PostDaoImpl(private val db: SQLiteDatabase) : PostDao {
    ...
    object PostColumns {
        ...
        const val COLUMN_LIKES = "likeByMeCount"
        const val COLUMN_SHARE = "shareByMeCount"
    ...
    override fun likeById(id: Long) {
        db.execSQL(
            ...
            UPDATE posts
            SET
                likeByMeCount = likeByMeCount + CASE WHEN likedByMe THEN -1 ELSE 1 END,
    ...
    override fun save(post: Post): Post {
        ...
        val values = ContentValues().apply {
            ...
            put(PostColumns.COLUMN_AUTHOR, "Мой")
            put(PostColumns.COLUMN_CONTENT, post.content)
            put(PostColumns.COLUMN_PUBLISHED, "сейчас")
    ...
    private fun map(cursor: Cursor): Post {
        with(cursor) {
            return Post(
                ...
                likeByMeCount = getLong(getColumnIndexOrThrow(PostColumns.COLUMN_LIKES)),
                shareByMeCount = getLong(getColumnIndexOrThrow(PostColumns.COLUMN_SHARE)),
